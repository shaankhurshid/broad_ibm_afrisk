...
write.csv(output,file='/data/arrhythmia/skhurshid/broad_ibm_afrisk/explore_beta_age_agerm.csv')

##################### Step 2: Graph coefficients for each model

# Graph
for (i in names(output)[4:20]){
pdf(file=paste0('/data/arrhythmia/skhurshid/broad_ibm_afrisk/hr_plots/',i,'.pdf'),pointsize=3,
      height=3,width=3.5)
