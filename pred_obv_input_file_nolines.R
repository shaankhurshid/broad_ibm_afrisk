...
# Load input data
coord <- fread('/data/arrhythmia/skhurshid/broad_ibm_afrisk/pred_obv_input.csv')
input <- fread('/data/arrhythmia/skhurshid/broad_ibm_afrisk/pred_obv_input2.csv')

# Plotting
# Open file connection
png("/data/arrhythmia/skhurshid/broad_ibm_afrisk/pred_obv_nolines.png",height=960,width=1800,res=100)

## Params
par(oma=c(1,1,0,0))

## x-scales
x1 <- coord[name=='CHADS-VASc']$x1
x2 <- coord[name=='CHARGE-AF']$x1
x3 <- coord[name=='EHR-AF']$x1
x4 <- coord[name=='C2HEST']$x1
