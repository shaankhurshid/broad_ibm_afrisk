...
# Load sample data
load(file='/data/arrhythmia/skhurshid/')

setDF(vs)

# Variable cleanup
vs$charge.risk <- vs$charge.pred5*100
vs$chads.risk <- vs$chads_pred5*100
vs$chest.risk <- vs$chest_pred5*100
...
# Function to obtain incidence estimates when given discrete cutoffs
