...
WORK_DIR = 'Y:/ibm-rwe_global/URI/Broad/'
setwd(WORK_DIR)
...
explore_categorical <- function(time,status,variable,data,risk_score,path=getwd(),
                                pred_risk,threshold,calib_quantiles=10,censor.t,make_plot=TRUE,horizon,
...
FILE = 'AFib_Data_Selection_Final_SUPERMART_122_Date_2021-01-05.csv'
...
output_age <- explore_age(time='af_5y_sal.t',status='af_5y_sal',min_age=45,max_age=90,age_step=5,
                          age_variable='start_fu_age',data=vs,path=WORK_DIR,
...
output_age <- explore_age(time='num_days_to_ASCVD_or_to_cencor',status='OUTCOME_is_ASCVD_in_follow_up',min_age=45,max_age=80,age_step=5,
                          age_variable='age',data=vs,path=WORK_DIR,
...
output_sex <- explore_categorical(time='num_days_to_ASCVD_or_to_cencor',status='OUTCOME_is_ASCVD_in_follow_up',variable='is_male',
                                  data=vs,risk_score='Individual_Sum_for_ASCVD_Score',pred_risk='ASCVD_Score_Percent',
