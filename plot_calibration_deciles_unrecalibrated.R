...
ehraf <- fread(file='/data/arrhythmia/skhurshid/broad_ibm_afrisk/cal_qual_ehr_af_raw_values_10.csv')
charge <- fread(file='/data/arrhythmia/skhurshid/broad_ibm_afrisk/cal_qual_charge_raw_values_10.csv')

# Plot 1: CHARGE-AF
pdf(file='/data/arrhythmia/skhurshid/broad_ibm_afrisk/charge_uncalibrated_10.pdf',
    height=4,width=4,pointsize=5)
par(mar=c(3,3,2,1),oma=c(3,3,1,1))
plot(x=charge$x,y=charge$y,xlim=c(0,30),ylim=c(0,30),xaxt='n',yaxt='n',
...
# Plot 1: EHR-AF
pdf(file='/data/arrhythmia/skhurshid/broad_ibm_afrisk/ehraf_uncalibrated_10.pdf',
    height=4,width=4,pointsize=5)
par(mar=c(3,3,2,1),oma=c(3,3,1,1))
plot(x=ehraf$x,y=ehraf$y,xlim=c(0,30),ylim=c(0,30),xaxt='n',yaxt='n',
