...
# Plot
pdf('/data/arrhythmia/skhurshid/broad_ibm_afrisk/subgroup_phs_hr_annotated.pdf',height=1.5,width=4.4,
    pointsize=3)

par(oma=c(1,1,1,1))
par(mar=c(4,16.5,1,1))
col <- c('#e31a1c','#ff7f00','#33a02c','#1f78b4','black')
plot(x=c_all[,1],y=seq(5,1,-1),xlim=c(1,3.5),ylim=c(0.75,5.25),
     xaxt='n',yaxt='n',xlab='',ylab='',pch=c(rep(19,4),18),col=col,cex=c(rep(1.4,4),3),
     bty='n')
axis(1,at=seq(1,3.5,0.25),cex=1.4,pos=0)
