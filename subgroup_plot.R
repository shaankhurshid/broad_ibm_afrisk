...
# Create all
all <- data.frame(Score_Name='EHR_AF_Final',Low_CI=0.807,CI_value=0.808,High_CI=0.809,N_outcome=153151,
...
plot(x=ehr$CI_value,y=seq(1,7,1),xlim=c(0.650,0.850),ylim=c(0.75,7),
     xaxt='n',yaxt='n',xlab='',ylab='',pch=c(18,rep(19,6)),col=rev(col),cex=c(3,rep(1.4,6)),bty='n')
axis(1,at=seq(0.650,0.850,0.025),cex=1.4,pos=0)
